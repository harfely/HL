...
<head>
    ...
    <title>WeHlcome To MY PART.</title>
    ...
    <div id="fh5co-page">
                ...
                <div class="header-inner">
                    ...
                    <nav role="navigation">
                        <ul>
                            ...
                            <li class="cta"><a href="https://www.youtube.com/channel/UCIPDlQycm0wkziSvJGBwH-w"
                                    target="_blank">Get
                                    started</a></li>
                        </ul>
                    </nav>
        ...
        <aside id="fh5co-hero" class="js-fullheight">
            <div class="flexslider js-fullheight">
                <ul class="slides">
                    <li style="background-image: url(<?php echo base_url().'theme/images/w2.jpg'?>);">
                        <div class="container">
                    ...
                    <li style="background-image: url(<?php echo base_url().'theme/images/w3.jpg'?>);">
                        <div class="container">
                            <div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
                                <div class="slider-text-inner">
