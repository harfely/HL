                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <ul class="contact-info">
                            <li><i class="icon-map"></i>Jln Ot Pattimaipauw, RT.003/RW.003, Talake, Kel Wainitu,
                                Nusaniwe, Kota Ambon, Maluku</li>
                            <li><i class="icon-phone"></i>+62 82198345926</li>
                            <li><i class="icon-envelope"></i><a href="#">leiparyharfely@gmail.com</a></li>
                            <li><i class="icon-globe"></i><a href="#">www.harfely.com</a></li>
                        </ul>
                    </div>
