...
<head>
    ...
    <title>Harfely | Add Portfolio</title>
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="treeview active">
                        ...
                        <ul class="treeview-menu">
                            <li class="active"><a href="<?php echo base_url().'admin/portfolio/add_portfolio'?>"><i
                                        class="fa fa-thumb-tack"></i> Add Portfolio</a></li>
                            <li><a href="<?php echo base_url().'admin/portfolio'?>"><i class="fa fa-list"></i> Portfolio
                                    List</a></li>
                        </ul>
                    </li>
    ...
    ?>
            ...
            <section class="content">
                ...
                <div class="box box-default">
                    ...
                    <form action="<?php echo base_url().'admin/portfolio/update_portfolio'?>" method="post"
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    ...
                                    <input type="text" name="xjudul" class="form-control"
                                        value="<?php echo $b['port_judul'];?>" placeholder="Judul" required />
                                </div>
                                <!-- /.col -->
                                <div class="col-md-2">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="box box-danger">
                            ...
                            <div class="box-body">
                                ...
                                <textarea id="ckeditor" name="xisi"
                                    required><?php echo $b['port_deskripsi'];?></textarea>
