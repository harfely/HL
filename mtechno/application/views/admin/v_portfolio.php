...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  ?>
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="<?php echo base_url().'admin/tulisan'?>"><i class="fa fa-list"></i> Post
                                    Lists</a></li>
                    ...
                    <li class="treeview active">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="<?php echo base_url().'admin/portfolio/add_portfolio'?>"><i
                                        class="fa fa-thumb-tack"></i> Add Portfolio</a></li>
                            <li class="active"><a href="<?php echo base_url().'admin/portfolio'?>"><i
                                        class="fa fa-list"></i> Portfolio List</a></li>
                        </ul>
                    </li>
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="row">
                            ...
                            <div class="box">
                                <div class="box-header">
                                    <a class="btn btn-success btn-flat"
                                        href="<?php echo base_url().'admin/portfolio/add_portfolio'?>"><span
                    ...
                    ?>
                                            <tr>
                                                <td><img src="<?php echo base_url().'assets/images/'.$port_gambar;?>"
                                                        style="width:90px;"></td>
                                                ...
                                                <td style="text-align:right;">
                                                    <a class="btn"
                                                        href="<?php echo base_url().'admin/portfolio/get_edit/'.$port_id;?>"><span
                                                            class="fa fa-pencil"></span></a>
                                                    <a class="btn" data-toggle="modal"
                                                        data-target="#ModalHapus<?php echo $port_id;?>"><span
    ...
    <div class="modal fade" id="ModalHapus<?php echo $port_id;?>" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form class="form-horizontal" action="<?php echo base_url().'admin/portfolio/hapus_portfolio'?>"
