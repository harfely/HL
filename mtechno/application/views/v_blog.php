    ...
    <div id="fh5co-page">
        ...
        <div class="fh5co-services">
            <div class="container">
				...
				?>
                    <div class="col-md-4">
                        <span class="icon"><img src="<?php echo base_url().'assets/images/'.$post_image;?>"
                        ...
                        <p><a href="<?php echo base_url().'artikel/'.$post_slug;?>"
                                class="btn btn-primary with-arrow">Selengkapnya <i class="icon-arrow-right"></i></a></p>
                    </div>
                    <?php endforeach;?>
